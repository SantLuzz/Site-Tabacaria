<?php
	...
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'contato@imperiolounge.com';//Trocar e-mail aqui!
		public $senha = '123456';//Trocar senha aqui!
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'br1028.hostgator.com.br'; //SERVIDOR SMTP DA HOSPEDAGEM
